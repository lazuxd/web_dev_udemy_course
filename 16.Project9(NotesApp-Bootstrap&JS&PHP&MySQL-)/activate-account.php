<?php
    ...
    //change email
    $users->activateAccount($_GET["key"], $_GET["email"]);
    if ($users->existErrors()) {
        ...
        $result = "<div class='alert alert-success'><strong>Activation succesful! Now you can <a href='#loginModal' data-toggle='modal'>log into</a> your account!</strong></div>";
    }
